                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <ul class="about-list list-unstyled open-sans-font">
                            ...
                            <li> <span class="title">langages :</span> <span class="value d-block d-sm-inline-block d-lg-block d-xl-inline-block">{{ @$getrecord[0]->languages }}</span> </li>
                        </ul>
                    </div>
                ...
                <div class="resume-box">
                    <ul>
                        <li>
                            ...
                            <span class="time open-sans-font text-uppercase">{{ @$getrecord[0]->years_of_present }} - Present</span>
                            <h5 class="poppins-font text-uppercase">{{ @$getrecord[0]->title }} <span class="place open-sans-font">{{ @$getrecord[0]->sub_title }}</span></h5>
                            <p style="text-align: justify;" class="open-sans-font">{{ @$getrecord[0]->description }}</p>
                        </li>
                    </ul>
                </div>
            </div>
