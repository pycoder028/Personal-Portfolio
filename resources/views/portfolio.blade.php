    ...
    <div id="grid-gallery" class="container grid-gallery">
        ...
        <section class="grid-wrap">
            <ul class="row grid">
                ...
                <li>
                    <figure>
                        <img src="{{ asset('public/img/projects/project-1.jpg') }}" alt="Portolio Image" />
                ...
                <li>
                    <figure>
                        <img src="{{ asset('public/img/projects/project-2.jpg') }}" alt="Portolio Image" />
                ...
                <li>
                    <figure>
                        <img src="{{ asset('public/img/projects/project-3.jpg') }}" alt="Portolio Image" />
                ...
                <li>
                    <figure>
                        <img src="{{ asset('public/img/projects/project-4.jpg') }}" alt="Portolio Image" />
                ...
                <li>
                    <figure>
                        <img src="{{ asset('public/img/projects/project-5.jpg') }}" alt="Portolio Image" />
                        <div><span>Image Project</span></div>
                    </figure>
                </li>
                <!-- Portfolio Item Ends -->
                ...
                <li>
                    <figure>
                        <img src="{{ asset('public/img/projects/project-6.jpg') }}" alt="Portolio Image" />
                        <div><span>Image Project</span></div>
                    </figure>
                </li>
                <!-- Portfolio Item Ends -->
                ...
                <li>
                    <figure>
                        <img src="{{ asset('public/img/projects/project-7.jpg') }}" alt="Portolio Image" />
                        <div><span>Image Project</span></div>
                    </figure>
                </li>
                <!-- Portfolio Item Ends -->
                ...
                <li>
                    <figure>
                        <img src="{{ asset('public/img/projects/project-8.jpg') }}" alt="Portolio Image" />
                        <div><span>Image Project</span></div>
                    </figure>
                </li>
                <!-- Portfolio Item Ends -->
                ...
                <li>
                    <figure>
                        <img src="{{ asset('public/img/projects/project-9.jpg') }}" alt="Portolio Image" />
                        <div><span>Image Project</span></div>
                    </figure>
                </li>
                <!-- Portfolio Item Ends -->
        ...
        <section class="slideshow">
            <ul>
                        ...
                        <div id="slider" class="carousel slide portfolio-slider" data-ride="carousel" data-interval="false">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="{{ asset('public/img/projects/project-3.jpg') }}" alt="slide 1">
                                </div>
                                <div class="carousel-item">
                                    <img src="{{ asset('public/img/projects/project-2.jpg') }}" alt="slide 2">
                                </div>
                                <div class="carousel-item">
                                    <img src="{{ asset('public/img/projects/project-1.jpg') }}" alt="slide 3">
                                </div>
                            </div>
                        </div>
                        <!-- Main Project Content Ends -->
                ...
                <li>
                    <figure>
                        ...
                        <!-- Project Details Ends -->
                        <!-- Main Project Content Starts -->
                        <video id="video" class="responsive-video" controls poster="{{ asset('public/img/projects/project-1.jpg') }}">
                            <source src="{{ asset('public/img/projects/video.mp4') }}" type="video/mp4">
                        </video>
                        <!-- Main Project Content Ends -->
                    </figure>
                </li>
            ...
            <nav>
                <span class="icon nav-prev"><img src="{{ asset('public/img/projects/navigation/left-arrow.png') }}" alt="previous"></span>
                <span class="icon nav-next"><img src="{{ asset('public/img/projects/navigation/right-arrow.png') }}" alt="next"></span>
                <span class="nav-close"><img src="{{ asset('public/img/projects/navigation/close-button.png') }}" alt="close"> </span>
            </nav>
